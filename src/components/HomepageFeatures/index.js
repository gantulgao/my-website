...
const FeatureList = [
  {
    ...
    description: (
      <>
        Клауд веб технологид суурилсан тул та интернэт холбогдсон бүх төрлийн
        төхөөрөмжөөс системд хандах боломжтой.
      </>
    ),
  },
  {
    title: "Зээлийн үйл ажиллагаа автоматжуулалт",
    Svg: require("@site/static/img/undraw_docusaurus_mountain.svg").default,
    description: (
      <>
        Зээлийн үйл ажиллагааг ажлын урсгалд суурилсан байдлаар автоматжуулж гар
